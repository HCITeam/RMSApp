...
<c:import url="./_head.jsp" var="head">
	<c:param name="title" value="User | GitMining"/>
</c:import>
${head}
			...
			<div class="board">
				...
				<div class="card grid-2-5 grid-1-1-sm grid-2-3-md">
					<div class="card-wrapper">
						...
						<div class="card-content">
							<div style="height: 300px" class="card-image" id="userScore">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card grid-2-5 grid-1-1-sm grid-2-3-md">
					<div class="card-wrapper">
						...
						<div class="card-content">
							<div style="height: 300px" class="card-image" id="userLan">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card grid-2-5 grid-1-1-sm grid-2-3-md">
					<div class="card-wrapper">
						...
						<div class="card-content">
							<div style="height: 550px;width: 800px" class="card-image" id="userContr">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card grid-2-5 grid-1-1-sm grid-2-3-md">
					<div class="card-wrapper">
						...
						<div class="card-content">
							<div style="height: 550px;width: 800px" class="card-image" id="userCommit">
							</div>
						</div>
					</div>
				</div>
