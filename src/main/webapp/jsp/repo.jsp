...
<c:import url="./_head.jsp" var="head">
	<c:param name="title" value="Repo | GitMining"/>
</c:import>
${head}
			...
			<div class="board">
				...
				<div class="card grid-1-1">
					<div class="card-wrapper">
						...
						<div class="card-content">
							<div style="height: 292px" id="repoAD">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card grid-1-1">
					<div class="card-wrapper">
						...
						<div class="card-content">
							<div style="height: 292px" id="repoPC">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-wrapper">
						...
						<div class="card-content">
							<c:forEach items="${memName}" var="name">
								<div style="height: 300px; width: 300px" class="card-image" id="${name}"></div>
							</c:forEach>
